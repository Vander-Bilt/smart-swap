...
def parse_args() -> None:
    ...
    program.add_argument('--disable-reg-notion', help='disable register notion', dest='reg_notion', action='store_false')
    program.add_argument('--disable-trigger-vercel', help='disable trigger vercel deploy', dest='trigger_vercel', action='store_false')
